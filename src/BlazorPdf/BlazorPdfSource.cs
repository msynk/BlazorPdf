...
/// </summary>
public sealed class BlazorPdfSource
{
    ...
    public static BlazorPdfSource FromBytes(byte[] bytes, string? fileName = null)
    ...
    public static BlazorPdfSource FromUrl(string url, string? fileName = null)
