...
/// <see cref="BlazorPdfDocument.Load(byte[], string?)"/> with a password.
/// </summary>
public sealed class BlazorPdfPasswordException : Exception
{
    ...
    public BlazorPdfPasswordException(string message, bool wasProvided) : base(message)
