...
/// <summary>The output of a <see cref="BlazorPdfCanvasRenderer"/> page render.</summary>
...
public sealed record BlazorPdfCanvasRenderResult(string TextLayerHtml, string OpsJson, double Width, double Height);
