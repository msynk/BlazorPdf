...
/// <see cref="BlazorPdfFormatException"/> so callers can surface a clear "this
/// encrypted PDF is not supported" message instead of loading ciphertext as if
/// it were valid content.
/// </summary>
public sealed class BlazorPdfUnsupportedEncryptionException : Exception
{
    public BlazorPdfUnsupportedEncryptionException(string message) : base(message) { }
    public BlazorPdfUnsupportedEncryptionException(string message, Exception inner) : base(message, inner) { }
}
