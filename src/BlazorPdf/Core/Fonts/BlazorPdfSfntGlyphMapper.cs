...
internal static class BlazorPdfSfntGlyphMapper
{
    /// <summary>
        ...
        Func<int, string> codeToUnicode, out HashSet<int> mappedCodes)
    {
        ...
        try
        {
            ...
            for (int code = 0; code < 256; code++)
            {
                ...
                result[BlazorPdfFont.GlyphPua + code] = gid;
            ...
            return BlazorPdfCmapBuilder.BuildUnicodeCmap(result);
        }
        catch
        {
            return null;
        ...
        Dictionary<string, int>? names)
    {
        ...
        {
            string u = BlazorPdfGlyphList.ToUnicode(glyphName);
