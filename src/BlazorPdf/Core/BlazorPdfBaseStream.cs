...
/// </summary>
public abstract class BlazorPdfBaseStream
{
    ...
    public BlazorPdfDict? Dict { get; set; }
    ...
    public abstract BlazorPdfBaseStream MakeSubStream(int start, int length, BlazorPdfDict? dict = null);
}
