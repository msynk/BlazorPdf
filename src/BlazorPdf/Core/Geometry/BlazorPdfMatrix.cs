...
/// </summary>
public readonly struct BlazorPdfMatrix
{
    public double A { get; }
    public double B { get; }
    public double C { get; }
    ...
    public BlazorPdfMatrix(double a, double b, double c, double d, double e, double f)
    {
        A = a; B = b; C = c; D = d; E = e; F = f;
    }

    /// <summary>The identity transform.</summary>
    public static readonly BlazorPdfMatrix Identity = new(1, 0, 0, 1, 0, 0);

    /// <summary>
    /// Concatenates two transforms so that the result applies <paramref name="inner"/>
    /// first and <paramref name="outer"/> second.
    /// </summary>
    public static BlazorPdfMatrix Concat(BlazorPdfMatrix outer, BlazorPdfMatrix inner) => new(
    ...
    public BlazorPdfMatrix? Invert()
    {
        ...
        double e = -(a * E + c * F);
        double f = -(b * E + d * F);
        return new BlazorPdfMatrix(a, b, c, d, e, f);
    }
