...
internal static class JpegDecoder
{
    ...
    public static JpegImage? Decode(byte[] data)
    {
        try
        {
    ...
    private static JpegImage? DecodeCore(byte[] data)
    {
        int pos = 0;
        var quant = new int[4][];
    ...
    private static JpegImage AssembleImage(int width, int height, Component[] components,
        bool adobe, int adobeTransform)
    {
        ...
        return new JpegImage { Width = width, Height = height, Components = nc, Data = data };
    }
