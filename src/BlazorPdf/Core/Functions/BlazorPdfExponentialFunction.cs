...
internal sealed class BlazorPdfExponentialFunction : BlazorPdfFunction
{
    ...
    private BlazorPdfExponentialFunction(double[] c0, double[] c1, double n, double[] domain)
    {
        _c0 = c0;
        _c1 = c1;
        _n = n;
    ...
    public static BlazorPdfExponentialFunction Build(BlazorPdfDict dict, IBlazorPdfXRef? xref = null)
    {
        ...
        return new BlazorPdfExponentialFunction(c0, c1, n, domain);
    }
